...
// } console.log(primo1(7));
// console.log(primo1(2))
// console.log(primo1(5))
// console.log(primo1(24))
// console.log(primo1(7))
...
function num (multiplicador) {
  
  let resultado;
  for (let i = 0; i < multiplicador.length; i = i + 1) {
    for(let j = 1; j < 9; j = j + 1) {
      resultado = multiplicador[i] * j;
      console.log(multiplicador[i] + ' x ' + j + ' = ' + resultado)
