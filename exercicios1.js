...
// // 14. Crie uma função que receba como parâmetro um array de  número e retorne  se o número é positivo ou se o número for negativo.
function parImpar(n) {
    let par = []
    let impar = []
...
let arr  // console.log(parImpar(8565895485751745));
